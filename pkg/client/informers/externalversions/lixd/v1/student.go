...
import (
	...
	versioned "i-controller/pkg/client/clientset/versioned"
	internalinterfaces "i-controller/pkg/client/informers/externalversions/internalinterfaces"
	v1 "i-controller/pkg/client/listers/lixd/v1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.LixdV1().Students(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LixdV1().Students(namespace).Watch(context.TODO(), options)
			},
		},
		&lixdv1.Student{},
		resyncPeriod,
...
func (f *studentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&lixdv1.Student{}, f.defaultInformer)
}
